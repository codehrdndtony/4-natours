...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHN0dG9ueTg1IiwiYSI6ImNrdjVmcnc4bTJuMDUybnF3MGkwY2RycmgifQ.sdSSEMBALgXYVF55mJOq3g';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.01:3000/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            urlPart = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(urlPart),
              data: data
            });
...
var loginForm = document.querySelector('.login-form--fields');
